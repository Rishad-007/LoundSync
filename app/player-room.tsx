      ...
      >
        ...
        >
            ...
            <View style={styles.headerTop}>
              ...
              {isHost && (
                <View style={styles.hostBadge}>
                  <Ionicons name="star" size={16} color={theme.colors.neon.yellow} />
          ...
          <GlassCard intensity="medium" style={styles.infoCard}>
            <View style={styles.infoRow}>
              <View style={styles.infoItem}>
                <Ionicons name="people" size={24} color={theme.colors.neon.cyan} />
                <AppText variant="h4">{connectedDevices}</AppText>
                <AppText variant="caption">Devices</AppText>
              </View>
              <View style={styles.divider} />
              <View style={styles.infoItem}>
                <Ionicons name="wifi" size={24} color={theme.colors.neon.green} />
                <AppText variant="h4">12ms</AppText>
                <AppText variant="caption">Latency</AppText>
              </View>
              <View style={styles.divider} />
              <View style={styles.infoItem}>
                <Ionicons name="volume-high" size={24} color={theme.colors.neon.purple} />
          ...
          <GlassCard intensity="heavy" style={styles.playerCard}>
            ...
            >
              <Ionicons name="musical-notes" size={64} color={theme.colors.white} />
            </LinearGradient>
            ...
            <View style={styles.controls}>
              <IconButton
                icon={<Ionicons name="play-skip-back" size={28} color={theme.colors.white} />}
                variant="ghost"
                size="lg"
              ...
              <IconButton
                icon={<Ionicons name="play-skip-forward" size={28} color={theme.colors.white} />}
                variant="ghost"
                size="lg"
          ...
          <View style={styles.usersSection}>
            ...
            <GlassCard intensity="medium" style={styles.userCard}>
              <View style={styles.userRow}>
                <View style={[styles.userAvatar, { backgroundColor: theme.colors.neon.pink }]}>
            ...
            <GlassCard intensity="medium" style={styles.userCard}>
              <View style={styles.userRow}>
                <View style={[styles.userAvatar, { backgroundColor: theme.colors.neon.cyan }]}>
                  <AppText variant="body" weight="bold">
                    JD
                  </AppText>
                </View>
            ...
            <GlassCard intensity="medium" style={styles.userCard}>
              <View style={styles.userRow}>
                <View style={[styles.userAvatar, { backgroundColor: theme.colors.neon.purple }]}>
                  <AppText variant="body" weight="bold">
                    AS
                  </AppText>
                </View>
